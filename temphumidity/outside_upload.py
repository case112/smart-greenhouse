...
log = []
with open("logOutside.txt", "r") as fp:
    for i in fp.readlines():
        i = i.strip()
        tmp = i.split(",")
        log.append((tmp[0], tmp[1], tmp[2], tmp[3]))
print log
...
if connection == 1 and log != []:
    ...
    while True:
        ...
        cur = db.cursor()
        sql = "INSERT INTO outside (datetime,sensor,temp,hum) VALUES (%s, %s, %s, %s)"
